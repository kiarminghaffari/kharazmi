...
if prediction == 0:
    ...
    st.title('زیاد')
    st.write('ظاهر شما منظم و کنترل شده به نطر می رسد،اما در درون به نگرانی و تزلزل گرایش دارید،یه آینده ای بهتر امیدوار باشید،میتوانید با استفاده از همین برنامه چک کنید که اگر چه چیزی را در زندگی تان تغییر دهید بهتر خواهید شد ')
    from PIL import Image
